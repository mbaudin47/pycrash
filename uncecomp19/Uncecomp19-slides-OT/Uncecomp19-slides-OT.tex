...
\item The absolute accuracy of the estimate $\mu$ can be evaluated based on the sample
standard deviation of the estimator $\frac{s}{\sqrt{n}}$ 

\item Goal of the algorithm: use the smallest possible sample which achieves 
a given accuracy. 
...
\item To do this, Paraview uses OpenTURNS to perform the Karhunen-Loève 
decomposition. 
